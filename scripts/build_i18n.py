...
"s3_p": {
 "en": "Show a friend your QR code — or send a tiny passport file — and see both journeys on one three-color map: only you, only them, and everywhere you've both been. No accounts. The passport itself never leaves the two phones.",
 "fr": "Montrez votre code QR à un ami — ou envoyez un minuscule fichier passeport — et voyez les deux parcours sur une carte à trois couleurs : seulement vous, seulement l'autre, et partout où vous êtes allés tous les deux. Pas de comptes. Le passeport lui-même ne quitte jamais les deux téléphones.",
 "es": "Muéstrale a un amigo tu código QR — o envía un pequeño archivo de pasaporte — y ve ambos recorridos en un mapa de tres colores: solo tú, solo él, y todos los lugares donde ambos han estado. Sin cuentas. El pasaporte en sí nunca sale de los dos teléfonos.",
 "it": "Mostra a un amico il tuo codice QR — o invia un piccolo file passaporto — e guarda entrambi i percorsi su una mappa a tre colori: solo tu, solo l'altro, e ovunque siate stati entrambi. Niente account. Il passaporto stesso non lascia mai i due telefoni.",
 "de": "Zeig einem Freund deinen QR-Code — oder schick eine winzige Passdatei — und seht beide Reisen auf einer dreifarbigen Karte: nur du, nur er, und überall, wo ihr beide wart. Keine Konten. Der Pass selbst verlässt die beiden Telefone nie.",
 "ro": "Arată-i unui prieten codul tău QR — sau trimite un fișier-pașaport minuscul — și vedeți ambele călătorii pe o hartă în trei culori: doar tu, doar el, și oriunde ați fost amândoi. Fără conturi. Pașaportul în sine nu părăsește niciodată cele două telefoane.",
},
"s4_h": {
 ...
 "sections": [
  ...
  {"h":{"en":"Anonymous statistics and crash reports","fr":"Statistiques anonymes et rapports de plantage","es":"Estadísticas anónimas e informes de fallos","it":"Statistiche anonime e rapporti di crash","de":"Anonyme Statistiken und Absturzberichte","ro":"Statistici anonime și rapoarte de eroare"},
   "p":{"en":"When you first open Voymark, it asks whether you want to help improve it. You have three answers: send anonymous usage statistics and crash reports, send crash reports only, or send nothing at all. The first answer is selected to begin with, and you can pick another before you continue. Nothing is sent until you do continue, and you can change the answer whenever you like under More → Privacy. If you choose to send something, this is the whole of it:",
        "fr":"À la première ouverture, Voymark vous demande si vous souhaitez l'aider à s'améliorer. Trois réponses : envoyer des statistiques d'usage anonymes et des rapports de plantage, envoyer uniquement les rapports de plantage, ou ne rien envoyer. La première réponse est sélectionnée au départ, et vous pouvez en choisir une autre avant de continuer. Rien n'est envoyé tant que vous n'avez pas continué, et vous pouvez changer d'avis à tout moment dans Plus → Confidentialité. Si vous choisissez d'envoyer quelque chose, voici l'intégralité :",
        "es":"Al abrir Voymark por primera vez, te pregunta si quieres ayudar a mejorarlo. Tienes tres respuestas: enviar estadísticas de uso anónimas e informes de fallos, enviar solo informes de fallos, o no enviar nada. La primera respuesta viene seleccionada de inicio, y puedes elegir otra antes de continuar. No se envía nada hasta que continúas, y puedes cambiar la respuesta cuando quieras en Más → Privacidad. Si eliges enviar algo, esto es todo:",
        "it":"Alla prima apertura, Voymark ti chiede se vuoi aiutarlo a migliorare. Hai tre risposte: inviare statistiche d'uso anonime e rapporti di crash, inviare solo i rapporti di crash, oppure non inviare nulla. La prima risposta è selezionata all'inizio, e puoi sceglierne un'altra prima di continuare. Nulla viene inviato finché non continui, e puoi cambiare idea quando vuoi in Altro → Privacy. Se scegli di inviare qualcosa, è tutto qui:",
        "de":"Beim ersten Öffnen fragt Voymark, ob du helfen möchtest, es zu verbessern. Du hast drei Antworten: anonyme Nutzungsstatistiken und Absturzberichte senden, nur Absturzberichte senden, oder gar nichts senden. Die erste Antwort ist zu Beginn ausgewählt, und du kannst vor dem Fortfahren eine andere wählen. Bis du fortfährst, wird nichts gesendet, und du kannst die Antwort jederzeit unter Mehr → Datenschutz ändern. Wenn du dich fürs Senden entscheidest, ist das alles:",
        "ro":"La prima deschidere, Voymark te întreabă dacă vrei să-l ajuți să devină mai bun. Ai trei răspunsuri: trimite statistici anonime de utilizare și rapoarte de eroare, trimite doar rapoarte de eroare, sau nu trimite nimic. Primul răspuns este selectat de la început, și poți alege altul înainte să continui. Nu se trimite nimic până când nu continui, iar răspunsul poate fi schimbat oricând din Mai multe → Confidențialitate. Dacă alegi să trimiți ceva, asta e tot:"},
   "list":{
  ...
  {"h":{"en":"The QR scanner","fr":"Le lecteur de QR code","es":"El lector de códigos QR","it":"Il lettore di codici QR","de":"Der QR-Scanner","ro":"Scanerul de coduri QR"},
   "p":{"en":"Comparing passports with a friend can be done by scanning a QR code, which is why both apps ask for camera permission the first time you open that screen. The camera image is decoded as it arrives and is never stored, never saved to your library and never sent anywhere. If you would rather not grant it, the same comparison works through a file or a pasted code, and the permission is never requested anywhere else in the app.",
        "fr":"La comparaison de passeports avec un ami peut se faire en scannant un QR code, c'est pourquoi les deux apps demandent l'accès à l'appareil photo la première fois que vous ouvrez cet écran. L'image est décodée à la volée : elle n'est jamais stockée, jamais enregistrée dans votre photothèque et jamais envoyée nulle part. Si vous préférez ne pas l'accorder, la même comparaison fonctionne par fichier ou par code collé, et l'autorisation n'est demandée nulle part ailleurs dans l'app.",
        "es":"Comparar pasaportes con un amigo puede hacerse escaneando un código QR, por eso ambas apps piden permiso de cámara la primera vez que abres esa pantalla. La imagen se descodifica al vuelo: nunca se almacena, nunca se guarda en tu galería y nunca se envía a ningún sitio. Si prefieres no concederlo, la misma comparación funciona con un archivo o un código pegado, y el permiso no se pide en ningún otro lugar de la app.",
        "it":"Confrontare i passaporti con un amico può avvenire scansionando un codice QR, ed è per questo che entrambe le app chiedono il permesso della fotocamera la prima volta che apri quella schermata. L'immagine viene decodificata al volo: non viene mai memorizzata, mai salvata nella tua libreria e mai inviata da nessuna parte. Se preferisci non concederlo, lo stesso confronto funziona con un file o un codice incollato, e il permesso non viene richiesto in nessun altro punto dell'app.",
        "de":"Pässe mit Freunden zu vergleichen geht per QR-Code — deshalb fragen beide Apps beim ersten Öffnen dieses Bildschirms nach der Kameraberechtigung. Das Kamerabild wird im Vorbeigehen dekodiert: Es wird nie gespeichert, nie in deine Bibliothek gelegt und nie irgendwohin gesendet. Willst du sie nicht erteilen, funktioniert derselbe Vergleich über eine Datei oder einen eingefügten Code, und die Berechtigung wird sonst nirgends in der App verlangt.",
        "ro":"Compararea pașapoartelor cu un prieten se poate face scanând un cod QR, de aceea ambele aplicații cer permisiunea camerei prima dată când deschizi acel ecran. Imaginea este decodificată din mers: nu este niciodată stocată, niciodată salvată în galeria ta și niciodată trimisă undeva. Dacă preferi să nu o acorzi, aceeași comparare merge printr-un fișier sau un cod lipit, iar permisiunea nu este cerută nicăieri altundeva în aplicație."}},
  ...
  {"h":{"en":"Anonymous statistics — the only thing we can delete for you","fr":"Statistiques anonymes — la seule chose que nous pouvons supprimer pour vous","es":"Estadísticas anónimas — lo único que podemos eliminar por ti","it":"Statistiche anonime — l'unica cosa che possiamo cancellare per te","de":"Anonyme Statistiken — das Einzige, was wir für dich löschen können","ro":"Statistici anonime — singurul lucru pe care îl putem șterge pentru tine"},
   ...
   "list":{
    "en":["Stop future collection: open More → Privacy in the app and switch it off. This takes effect immediately and needs no message to us.",
          ...
          "You will get a confirmation once the request is filed — we aim to do that within 7 days, and the GDPR requires it within one month. Google then removes the data from reporting within 72 hours and deletes it from its servers within two months; those last steps are Google's timetable, not ours, which is why we confirm the filing rather than the erasure. Data nobody asks us to delete expires by itself after 14 months."],
    "fr":["Arrêter les collectes futures : ouvrez Plus → Confidentialité dans l'app et désactivez. L'effet est immédiat et ne nécessite aucun message.",
          ...
          "Vous recevrez une confirmation dès que la demande est déposée — nous visons 7 jours, et le RGPD impose un mois. Google retire ensuite les données du reporting sous 72 heures et les efface de ses serveurs sous deux mois ; ces derniers délais sont ceux de Google, pas les nôtres, c'est pourquoi nous confirmons le dépôt et non l'effacement. Les données que personne ne nous demande de supprimer expirent d'elles-mêmes après 14 mois."],
    "es":["Detener la recogida futura: abre Más → Privacidad en la app y desactívalo. Es inmediato y no requiere escribirnos.",
          ...
          "Recibirás una confirmación en cuanto se presente la solicitud — aspiramos a 7 días, y el RGPD exige un mes. Google retira después los datos de los informes en 72 horas y los borra de sus servidores en dos meses; esos últimos plazos son de Google, no nuestros, por eso confirmamos la presentación y no el borrado. Los datos que nadie nos pide eliminar caducan solos a los 14 meses."],
    "it":["Fermare le raccolte future: apri Altro → Privacy nell'app e disattiva. L'effetto è immediato e non richiede alcun messaggio.",
          ...
          "Riceverai conferma appena la richiesta è inoltrata — puntiamo a 7 giorni, e il GDPR impone un mese. Google rimuove poi i dati dalla reportistica entro 72 ore e li cancella dai suoi server entro due mesi; questi ultimi tempi sono di Google, non nostri, ed è per questo che confermiamo l'inoltro e non la cancellazione. I dati che nessuno ci chiede di cancellare scadono da soli dopo 14 mesi."],
    "de":["Künftige Erhebung stoppen: Öffne Mehr → Datenschutz in der App und schalte sie aus. Das wirkt sofort und braucht keine Nachricht an uns.",
          ...
          "Du bekommst eine Bestätigung, sobald die Anfrage gestellt ist — wir wollen das binnen 7 Tagen tun, die DSGVO verlangt es binnen eines Monats. Google entfernt die Daten dann binnen 72 Stunden aus der Berichterstattung und löscht sie binnen zwei Monaten von seinen Servern; diese letzten Fristen sind Googles, nicht unsere, weshalb wir die Einreichung bestätigen und nicht die Löschung. Was niemand zu löschen verlangt, verfällt nach 14 Monaten von selbst."],
    "ro":["Oprește colectarea viitoare: deschide Mai multe → Confidențialitate în aplicație și dezactiveaz-o. Are efect imediat și nu necesită niciun mesaj către noi.",
          ...
          "Vei primi o confirmare imediat ce cererea este depusă — ne propunem în 7 zile, iar GDPR impune o lună. Google scoate apoi datele din raportare în 72 de ore și le șterge de pe serverele sale în două luni; aceste ultime termene sunt ale Google, nu ale noastre, de aceea confirmăm depunerea, nu ștergerea. Datele pe care nimeni nu ne cere să le ștergem expiră singure după 14 luni."]},
...
"visited-countries-map": {
 ...
 "sections": [
  ...
  {"h":{"en":"Private by architecture","fr":"Privé par architecture","es":"Privado por arquitectura","it":"Privato per architettura","de":"Privat per Architektur","ro":"Privat prin arhitectură"},
   "p":{"en":"The whole map ships inside the app. No accounts, no tracking, and your travel history is never uploaded anywhere — it belongs to you.",
        "fr":"Toute la carte est livrée dans l'app. Pas de compte, pas de suivi, et votre historique de voyage n'est jamais envoyé nulle part — il vous appartient.",
        "es":"Todo el mapa viene dentro de la app. Sin cuentas, sin rastreo, y tu historial de viajes nunca se sube a ninguna parte — te pertenece.",
        "it":"Tutta la mappa è inclusa nell'app. Niente account, niente tracciamento, e la tua storia di viaggio non viene mai caricata da nessuna parte — appartiene a te.",
        "de":"Die ganze Karte steckt in der App. Keine Konten, kein Tracking, und deine Reisegeschichte wird nie irgendwohin hochgeladen — sie gehört dir.",
        "ro":"Întreaga hartă vine în aplicație. Fără conturi, fără urmărire, iar istoria ta de călătorie nu este niciodată încărcată nicăieri — îți aparține."}},
